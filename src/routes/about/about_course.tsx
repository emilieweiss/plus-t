    ...
    <div>
      <div className="flex flex-col items-center px-6 pt-8 md:px-20 md:pt-16 lg:px-40">
        <div className="max-w-3xl">
          ...
          <h2>Pak vandtæt</h2>
          <p>
            Det danske efterår kan byde på alt fra solskin til skybrud – og
            nogle gange begge dele på samme dag. Hvis tasken skal ud og svømme,
            duer et par poser uden knude ikke. Man skal ikke regne med at kunne
            tørre sine ting undervejs, så sørg for at pakke alt vandtæt – det
            kan ikke understreges nok.
          </p>
          <br />
          <h2>Læs deltagerbrevet</h2>
          <p>
