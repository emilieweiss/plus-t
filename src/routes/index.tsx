    ...
    <div className="flex flex-col items-center">
      <div className="relative w-full">
        ...
        <div className="hidden md:block absolute right-20 top-0 bg-gradient-to-b from-brand-black to-brand-black/70 text-white p-8 rounded-b-lg z-20 max-w-2xl">
          ...
          <p>Er du klar til en uge fyldt med vilde udfordringer, nye venskaber og oplevelser, du aldrig glemmer? Så tag på PLUS T, seniorkurset hvor vi skruer vi op for eventyret og udfordringen.</p>
          <p>Det bliver intenst. Det bliver krævende. Det bliver årets vildeste efterårsferie! Er du klar?</p>
        </div>
      </div>
